...
# config_entry_flow.register_discovery_flow(DOMAIN, "Silla", _async_has_devices)
...
class FlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_mqtt(self, discovery_info: DiscoveryInfoType) -> FlowResult:
        ...
        assert discovery_info["subscribed_topic"] == "home/prism/#"
        self._prefix = "home/prism"
